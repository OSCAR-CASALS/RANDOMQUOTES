class App extends React.Component{
    ...
    render(){
        const quotes = [
            ...
            ["Three failures denote uncommon strength.\nA weakling has not enough grit to fail thrice.", "Minna Thomas Antrim"],
            ["Think twice before you speak,\nand then you may be able to say something more insulting than if you spoke right out at once.", "Evan Esar"],
            ["Mi habitación es un universo en miniatura,\nTiene tendencia al desorden.", "Me"],
